        ...
        <SettingsLayout>
            <div class="space-y-6">
                <Heading
                    variant="small"
                    title="Authentification à deux facteurs"
                    description="Gérer les paramètres d'authentification à deux facteurs"
                />
                ...
                >
                    ...
                    <p class="text-muted-foreground">
                        ...
                        Ce code peut être obtenu depuis une application
                    ...
                    <div>
                        ...
                        >
                            <Button type="submit" :disabled="processing">
                                <ShieldCheck />Activer l'authentification à deux facteurs</Button
                            ></Form
                        >
                    </div>
                </div>
                ...
                >
                    ...
                    <p class="text-muted-foreground">
                        ...
                        un code sécurisé et aléatoire vous sera demandé lors de
                        la connexion, que vous pouvez obtenir depuis une
